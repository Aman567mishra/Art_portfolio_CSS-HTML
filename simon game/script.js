...
const topLeft = document.getElementById("blue");
const topRight = document.getElementById("yellow");
const bottomLeft = document.getElementById("red");
const bottomRight = document.getElementById("green");
...
function clearColor() {
  topLeft.style.backgroundColor = "darkblue";
